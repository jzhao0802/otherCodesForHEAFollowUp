...
libname outdir "F:\shire_followup\data\200K_2.3M\2.5M_from_123M_C.11_1";
libname outdir1 "F:\shire_followup\data\200K_2.3M";
...
proc export data=indir.final_data_pt
outfile="F:\shire_followup\data\200K_2.3M\2.5M_from_123M_C.11_1\final_data_pt_123M.csv"
dbms=csv replace;
run;
...
*/
proc sql;
select count(*) from outdir1.final_data_pt_excLHAE;
quit;
