...
plots_path1 = "D:\\jzhao\\Shire_followup\\03_Results\\for_old200K&1233\\"
...
hae <- dat_hae_1111_rf_nov26 %>% select(-c(REGION, FLAG_))
# %>%
# {
...
save(dat_hae_trn, dat_hae_tst, dat_nonhae_trn , dat_nonhae_tst
     , file=paste(plots_path1, "dat_hae_trn_tst_split_Mar31.RData", sep=""))
...
for (m in 1:kfold_out){
    ...
    save(ans_lasso_rf, file=paste0(plots_path, 'rf_fit_on'))
