...
arglist <- list(bTestMode=T
                ...
                , resultDir= "F:\\Jie\\Shire_follow_up\\03_Results\\for200+b\\"
)
...
#         } %>%
        ...
        # remove all-zero patients
        {
            ...
            nonAllZeroPats
            HAE1087_ptid <- nonAllZeroPats$PATIENT_ID
            save(HAE1087_ptid, file=paste0(result_dir, 'HAE1087_ptid.RData'))
            save(HAE1087_ptid, file="F:\\Jie\\Shire_follow_up\\01_data\\HAE1087_ptid.RData")
        } %>%
        {
...
arglist <- list(dataDir='F:\\Jie\\Shire_follow_up\\03_Results\\for200+a\\'
